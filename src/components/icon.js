...
module.exports = AFRAME.registerComponent('ui-icon', {
    ...
    init() {
        this.icon = new THREE.Mesh(new THREE.PlaneGeometry(this.data.size.x,this.data.size.y),new THREE.MeshBasicMaterial({alphaTest:0.4,transparent:true,map:new THREE.TextureLoader().load(this.data.src)}));
